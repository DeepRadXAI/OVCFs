...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset004_OVCFs/nnUNetTrainerUMambaEnc__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset004_OVCFs/imagesTs'),
                                 join(nnUNet_raw, 'Dataset004_OVCFs/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, '/root/autodl-tmp/U-Mamba/DATASET/nnUNet_raw/Dataset004_OVCFs/imagesTs/xxxx_0000.nii.gz')])
